...
var $strongName = '50E8E282791F7CD775EDE73CED4E9F87';
...
function $clinit_0(){
  $clinit_0 = nullMethod;
  BOUNDARY_STRINGS = initValues(_3Ljava_lang_String_2_classLit, {16:1}, 1, ['StartToStart', 'StartToEnd', 'EndToEnd', 'EndToStart']);
}
...
function $getAbsoluteLeft(elem){
  ...
  return round_int(Math.floor($getBoundingClientRectLeft(elem) / $getZoomMultiple(doc) + $getScrollLeft($equals_0(doc.compatMode, 'CSS1Compat')?doc.documentElement:doc.body)));
}
...
function $initEventSystem(){
  ...
  var dispatchEvent_0 = $entry(function(){
    ...
    listener && !instanceOfJso(listener) && listener != null && listener.castableTypeMap$ && !!listener.castableTypeMap$[11] && dispatchEvent_1($wnd.event, curElem, listener);
    currentEventTarget = oldEventTarget;
  }
  );
...
_.newItemOnEvent = function newItemOnEvent(historyToken){
  ...
  if (!$equals_0(historyToken, token_0 == null?'':token_0)) {
